...
df_train = pd.read_csv('/tmp/tensorflow_linear/adult.data', names=COLUMNS, skipinitialspace=True)
df_test  = pd.read_csv('/tmp/tensorflow_linear/adult.test', names=COLUMNS, skipinitialspace=True, skiprows=1)
