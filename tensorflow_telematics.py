...
###############################################################################################################
#
#   Tensorflow - Simple Model (linear reg)
#
###############################################################################################################

# Download Data (Census Income)
'''
mkdir /tmp/tensorflow_linear
cd /tmp/tensorflow_linear
...
df_train = pd.read_csv('/tmp/tensorflow_linear/telematics.txt', names=COLUMNS, skipinitialspace=True, skiprows=1)
df_test  = pd.read_csv('/tmp/tensorflow_linear/telematics.txt', names=COLUMNS, skipinitialspace=True, skiprows=1)
...
#predictions   = list(itertools.islice(prediction, 10))
